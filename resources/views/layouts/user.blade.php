                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="{{ route('products') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Products Us</a>
                                ...
                                <a href="{{ url('/cart') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Cart</a>
                                <a href="{{ url('/order') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Order</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <div x-data="{show: false}" x-on:click.away="show = false" class="ml-3 relative">
                                <button x-on:click="show = !show" type="button" class="max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                    ...
                                    <img class="h-8 w-8 rounded-full" src="{{ auth()->user()->image }}" alt="User Profile Image">
                                </button>
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="pt-4 pb-3 border-t border-gray-700">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            <div class="text-base font-medium leading-none text-white" style="color: white;">Tom Cook</div>
                            <div class="text-sm font-medium leading-none text-white-400" style="color: white;">tom@example.com</div>
                        </div>
                    ...
                    <div class="mt-3 px-2 space-y-1">
                        <a href="/userprofile" class="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700">Your Profile</a>
